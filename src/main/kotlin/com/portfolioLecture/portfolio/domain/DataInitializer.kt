package com.portfolioLecture.portfolio.domain

import com.portfolioLecture.portfolio.domain.constant.SkillType
import com.portfolioLecture.portfolio.domain.entity.*
import com.portfolioLecture.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    fun initializeData() {
        ...
        val introductions = mutableListOf<Introduction>(
            Introduction(content = "주기적으로 문제를 찾고, 해결하는 고양이입니다.", isActive = true),
            Introduction(content = "기술을 위한 기술이 아닌 비즈니스 문제를 플기 위한 기술을 추구하빈다.", isActive = true),
